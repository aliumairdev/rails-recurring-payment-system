...
ActiveRecord::Schema.define(version: 2022_05_12_083605) do
  ...
  create_table "features", force: :cascade do |t|
    ...
    t.string "stripe_metered_price"
    t.string "stripe_price"
    t.string "stripe_product"
    t.index ["manager_id"], name: "index_features_on_manager_id"
  end
  ...
  create_table "plans", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["manager_id"], name: "index_plans_on_manager_id"
  end
  ...
  add_foreign_key "features", "users", column: "manager_id"
  add_foreign_key "pay_charges", "pay_customers", column: "customer_id"
  add_foreign_key "pay_charges", "pay_subscriptions", column: "subscription_id"
  add_foreign_key "pay_payment_methods", "pay_customers", column: "customer_id"
  add_foreign_key "pay_subscriptions", "pay_customers", column: "customer_id"
  add_foreign_key "plans", "users", column: "manager_id"
end
